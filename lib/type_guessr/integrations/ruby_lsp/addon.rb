...
require "prism"
require_relative "hover_provider"

# Explicitly require core dependencies used by this addon
require_relative "../../version" unless defined?(TypeGuessr::VERSION)
require_relative "../../core/ast_analyzer"
require_relative "../../core/rbs_indexer"
require_relative "../../core/variable_index"
require_relative "../../core/method_signature_index"
    ...
    module RubyLsp
      ...
      class Addon < ::RubyLsp::Addon
        ...
        def create_hover_listener(response_builder, node_context, dispatcher)
          HoverProvider.new(response_builder, node_context, dispatcher, @global_state)
        end
