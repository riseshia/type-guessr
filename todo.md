...
> MVP Goal: Hover에서 타입 표시 (practical type flowing without full rigor)
...
- `Unknown` is actively allowed: "모르면 모른다"
...
- [ ] Implement lazy loading (A안): load on first signature query, then memoize
