...
RSpec.describe "Container Type Inference", :doc do
  describe "Array type inference" do
    context "Homogeneous integer array" do
      ...
      it "→ [Integer, Integer, Integer]" do
        expect_inferred_type(line: 2, column: 0, expected: "[Integer, Integer, Integer]")
      end
    end
    ...
    context "Mixed array with 2 types" do
      ...
      it "→ [Integer, String]" do
        expect_inferred_type(line: 2, column: 0, expected: "[Integer, String]")
      end
    end
    ...
    context "Mixed array with 3 types" do
      ...
      it "→ [Integer, String, Symbol]" do
        expect_inferred_type(line: 2, column: 0, expected: "[Integer, String, Symbol]")
      end
    end
    ...
    context "Array with 4+ types" do
      ...
      it "→ [Integer, String, Symbol, Float]" do
        expect_inferred_type(line: 2, column: 0, expected: "[Integer, String, Symbol, Float]")
      end
    end
    ...
    context "Nested array" do
      ...
      it "→ [[Integer, Integer], [Integer, Integer]]" do
        expect_inferred_type(line: 2, column: 0, expected: "[[Integer, Integer], [Integer, Integer]]")
      end
    end
    ...
    context "Deeply nested array" do
      ...
      it "→ [[[Integer]]]" do
        expect_inferred_type(line: 2, column: 0, expected: "[[[Integer]]]")
      end
    end
    ...
    context "array with method chaining" do
      ...
      it "→ Array[Integer]" do
        expect_inferred_type(line: 6, column: 0, expected: "Array[Integer]")
      end
    end
  end
  ...
  describe "Hash type inference" do
    context "Symbol-keyed hash" do
      ...
      it "→ { name: String, age: Integer }" do
        expect_inferred_type(line: 2, column: 0, expected: "{ name: String, age: Integer }")
      end
    end
    ...
    context "String-keyed hash" do
      ...
      it "→ Hash[String, String]" do
        expect_inferred_type(line: 2, column: 0, expected: "Hash[String, String]")
      end
    end
    ...
    context "Mixed keys hash" do
      ...
      it "→ Hash[String | Symbol, Integer | String]" do
        expect_inferred_type(line: 2, column: 0, expected: "Hash[String | Symbol, Integer | String]")
      end
    end
    ...
    context "Nested symbol-keyed hash" do
      ...
      it "→ { name: String, address: { city: String } }" do
        expect_inferred_type(line: 2, column: 0, expected: "{ name: String, address: { city: String } }")
      end
    end
    ...
    context "hash with symbol keys and different value types" do
      ...
      it "→ { a: Integer, b: String }" do
        expect_inferred_type(line: 8, column: 0, expected: "{ a: Integer, b: String }")
      end
    end
    ...
    context "hash access with symbol key" do
      ...
      it "→ Integer" do
        expect_inferred_type(line: 12, column: 0, expected: "Integer")
      end
    end
    ...
    context "hash with indexed assignment" do
      ...
      it "→ nil" do
        ...
        expect_inferred_type(line: 13, column: 0, expected: "nil")
      end
    end
    ...
    context "hash with splat operator" do
      ...
      it "→ Hash[Symbol, Integer]" do
        expect_inferred_type(line: 9, column: 0, expected: "Hash[Symbol, Integer]")
      end
    end
    ...
    context "hash with implicit value syntax" do
      ...
      it "→ { x: untyped, y: untyped }" do
        expect_inferred_type(line: 7, column: 0, expected: "{ x: untyped, y: untyped }")
      end
    end
  end
  ...
  describe "Hash indexed assignment" do
    context "empty hash" do
      ...
      it "→ { x: Integer }" do
        expect_inferred_type(line: 3, column: 0, expected: "{ x: Integer }")
      end
    end
    ...
    context "existing hash" do
      ...
      it "→ { a: Integer, b: Integer }" do
        expect_inferred_type(line: 3, column: 0, expected: "{ a: Integer, b: Integer }")
      end
    end
    ...
    context "string key widens to Hash" do
      ...
      it "→ Hash" do
        expect_inferred_type(line: 3, column: 0, expected: "Hash[String | Symbol, Integer]")
      end
    end
    ...
    context "with symbol key" do
      ...
      it "→ { a: Integer, b: String }" do
        expect_inferred_type(line: 2, column: 0, expected: "{ a: Integer, b: String }")
      end
    end
  end
  ...
  describe "Hash indexed ||= assignment" do
    context "hash indexed ||= on empty hash" do
      ...
      it "→ Integer" do
        expect_inferred_type(line: 6, column: 0, expected: "Integer")
      end
    end
  end
  ...
  describe "Control flow container mutation" do
    context "Hash field added in if branch" do
      ...
      it "→ union of branch types (if may not execute)" do
        expect_inferred_type(line: 6, column: 2, expected: "{ a: Integer } | { a: Integer, b: String }")
      end
    end
    ...
    context "Array element added in case branch" do
      ...
      it "→ union of branch array types" do
        expect_inferred_type(line: 7, column: 2, expected: "[Integer, String] | [Integer, Symbol]")
      end
    end
  end
  ...
  describe "Sequential container expansion" do
    context "multiple Hash field additions" do
      ...
      it "→ { a: Integer, b: String, c: Symbol }" do
        expect_inferred_type(line: 5, column: 0, expected: "{ a: Integer, b: String, c: Symbol }")
      end
    end
    ...
    context "multiple Array element additions" do
      ...
      it "→ [Integer, String, Symbol]" do
        expect_inferred_type(line: 5, column: 0, expected: "[Integer, String, Symbol]")
      end
    end
    ...
    context "mixed Array operations" do
      ...
      it "→ [Integer, String, Symbol]" do
        expect_inferred_type(line: 4, column: 0, expected: "[Integer, String, Symbol]")
      end
    end
  end
  ...
  describe "TupleType inference" do
    ...
    context "Tuple indexed access with last element" do
      ...
      it "→ Symbol" do
        expect_inferred_type(line: 6, column: 0, expected: "Symbol")
      end
    end
    ...
    context "Tuple out of range access" do
      ...
      it "→ nil" do
        expect_inferred_type(line: 6, column: 0, expected: "nil")
      end
    end
  ...
  describe "Block container mutation" do
    context "block mutates outer array with different type" do
      ...
      it "→ Array[Integer | String]" do
        expect_inferred_type(line: 3, column: 0, expected: "Array[Integer | String]")
      end
    end
  ...
  describe "Container mutation edge cases" do
    context "container mutation followed by reassignment" do
      ...
      it "→ { x: Integer } (not Array)" do
        expect_inferred_type(line: 4, column: 0, expected: "{ x: Integer }")
      end
    end
  end
end
