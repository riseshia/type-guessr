...
RSpec.describe "Control Flow Type Inference", :doc do
  describe "If-else branches" do
    context "ternary operator with different types" do
      ...
      it "→ Integer | String" do
        expect_inferred_type(line: 4, column: 0, expected: "Integer | String")
      end
    end
    ...
    context "if modifier with assignment" do
      ...
      it "→ untyped" do
        expect_inferred_type(line: 5, column: 0, expected: "untyped")
      end
    end
    ...
    context "if-else with symbol literals" do
      ...
      it "→ Symbol" do
        expect_inferred_type(line: 8, column: 0, expected: "Symbol")
      end
    end
  end
  ...
  describe "Case expressions" do
    context "case with all branches returning different types" do
      ...
      it "→ Float | Integer | String" do
        expect_inferred_type(line: 11, column: 0, expected: "Float | Integer | String")
      end
    end
    ...
    context "case with raise in else clause" do
      ...
      it "→ Integer | String" do
        expect_inferred_type(line: 11, column: 0, expected: "Integer | String")
      end
    end
    ...
    context "case with all empty branches" do
      ...
      it "→ nil" do
        expect_inferred_type(line: 8, column: 0, expected: "nil")
      end
    end
  ...
  describe "Variable reassignment in control flow" do
    context "Conditional reassignment" do
      ...
      it "→ Integer | String" do
        expect_inferred_type(line: 6, column: 2, expected: "Integer | String")
      end
    end
    ...
    context "Type within branch" do
      ...
      it "→ String (within branch)" do
        expect_inferred_type(line: 5, column: 4, expected: "String")
        expect_inferred_type_excludes(line: 5, column: 4, types: ["Integer"])
      end
    end
    ...
    context "Simple reassignment" do
      ...
      it "→ String (after reassignment)" do
        ...
        expect_inferred_type_excludes(line: 4, column: 2, types: ["Integer"])
      end
    end
    ...
    context "reassignment in non-first-line method" do
      ...
      it "→ String" do
        expect_inferred_type(line: 9, column: 4, expected: "String")
        expect_inferred_type_excludes(line: 9, column: 4, types: ["Integer"])
      end
    end
    ...
    context "instance variable fallback" do
      ...
      it "→ String" do
        expect_inferred_type(line: 4, column: 4, expected: "String")
      end
    end
    ...
    context "elsif branches" do
      ...
      it "→ Integer | String | Symbol" do
        expect_inferred_type(line: 8, column: 2, expected: "Integer | String | Symbol")
      end
    end
    ...
    context "hash access with || fallback (variable key)" do
      ...
      it "→ [] (RHS used when LHS is unknown)" do
        expect_inferred_type(line: 4, column: 2, expected: "[]")
      end
    end
    ...
    context "&&= compound assignment" do
      ...
      it "→ Integer | String" do
        expect_inferred_type(line: 4, column: 2, expected: "Integer | String")
      end
    end
  ...
  describe "Guard Clause Type Narrowing" do
    context "return unless local_var narrows type" do
      ...
      it "→ String (NilClass removed after guard)" do
        expect_inferred_type(line: 5, column: 2, expected: "String")
        expect_inferred_type_excludes(line: 5, column: 2, types: ["NilClass"])
      end
    end
    ...
    context "return nil unless @ivar narrows instance variable" do
      ...
      it "→ [Integer, Integer, Integer] (NilClass removed after guard)" do
        expect_inferred_type(line: 12, column: 4, expected: "[Integer, Integer, Integer]")
      end
    end
    ...
    context "raise unless local_var narrows type" do
      ...
      it "→ Integer (NilClass removed after guard)" do
        expect_inferred_type(line: 5, column: 2, expected: "Integer")
        expect_inferred_type_excludes(line: 5, column: 2, types: ["NilClass"])
      end
    end
  end
  ...
  describe "Explicit Return Handling" do
    context "early return with guard clause" do
      ...
      it "→ (?true flag) -> bool" do
        expect_inferred_signature(line: 2, column: 6, expected_signature: "(?true flag) -> bool")
      end
    end
    ...
    context "multiple explicit returns" do
      ...
      it "→ (untyped n) -> String" do
        expect_inferred_signature(line: 2, column: 6, expected_signature: "(untyped n) -> String")
      end
    end
  end
end
