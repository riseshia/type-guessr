...
RSpec.describe "Literal Type Inference", :doc do
  describe "Basic literals" do
    ...
    context "Float literal" do
      ...
      it "→ Float" do
        expect_inferred_type(line: 2, column: 0, expected: "Float")
      end
    end
    ...
    context "Array literal" do
      ...
      it "→ []" do
        expect_inferred_type(line: 2, column: 0, expected: "[]")
      end
    end
    ...
    context "Symbol literal" do
      ...
      it "→ Symbol" do
        expect_inferred_type(line: 2, column: 0, expected: "Symbol")
      end
    end
    ...
    context "TrueClass literal" do
      ...
      it "→ true" do
        expect_inferred_type(line: 2, column: 0, expected: "true")
      end
    end
    ...
    context "FalseClass literal" do
      ...
      it "→ false" do
        expect_inferred_type(line: 2, column: 0, expected: "false")
      end
    end
    ...
    context "NilClass literal" do
      ...
      it "→ nil" do
        expect_inferred_type(line: 2, column: 0, expected: "nil")
      end
    end
  end
  ...
  describe "Range literals" do
    context "inclusive range (0..1)" do
      ...
      it "→ Range[Integer]" do
        expect_inferred_type(line: 4, column: 0, expected: "Range[Integer]")
      end
    end
    ...
    context "nil range (nil..nil)" do
      ...
      it "→ Range[nil]" do
        expect_inferred_type(line: 4, column: 0, expected: "Range[nil]")
      end
    end
  end
  ...
  describe "Complex number literal" do
    context "imaginary number (1i)" do
      ...
      it "→ Complex" do
        expect_inferred_type(line: 4, column: 0, expected: "Complex")
      end
    end
  end
  ...
  describe "Rational number literal" do
    context "rational number (1r)" do
      ...
      it "→ Rational" do
        expect_inferred_type(line: 4, column: 0, expected: "Rational")
      end
    end
  end
  ...
  describe "Regexp literal" do
    context "simple regexp (/foo/)" do
      ...
      it "→ Regexp" do
        expect_inferred_type(line: 4, column: 0, expected: "Regexp")
      end
    end
  ...
  describe "Interpolated strings" do
    context "string with interpolation" do
      ...
      it "→ String" do
        expect_inferred_type(line: 9, column: 0, expected: "String")
      end
    end
    ...
    context "string with empty interpolation" do
      ...
      it "→ String" do
        expect_inferred_type(line: 4, column: 0, expected: "String")
      end
    end
